...
sc1.plotly_chart(prob_gauge(orig_prob, "Baseline Probability (Up)"), width="stretch")
sc2.plotly_chart(prob_gauge(scen_prob, "Scenario Probability (Up)"),  width="stretch")
